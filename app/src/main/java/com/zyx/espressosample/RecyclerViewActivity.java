...
/**
 * Simple RecylcerViewActivity which hosts a {@link ViewPager} that contains
 * three {@link Fragment}s. Each Fragment contains a
  ...
  private static class RecyclerViewPagerAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
      RecyclerViewFragment fragment = RecyclerViewFragment
          .newInstance(RecyclerViewFragment.LayoutManagerType.LINEAR.values()[position]);
    ...
    @Override
    public int getCount() {
      return RecyclerViewFragment.LayoutManagerType.values().length;
    }

    @Override
    public CharSequence getPageTitle(int position) {
      return RecyclerViewFragment.LayoutManagerType.values()[position].toString();
    }
